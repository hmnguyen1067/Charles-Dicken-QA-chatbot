...
def define_settings(
    embed_model: str = "BAAI/bge-base-en-v1.5", llm_model: str = "gpt-5-mini"
):
    Settings.embed_model = get_fastembed_model(embed_model)
    Settings.llm_model = get_openai_model(llm_model)
...
def get_redis_cache_storage(collection_name: str, redis_host: str, redis_port: str):
    ...
    return redis_docstore, redis_cache
